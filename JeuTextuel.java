...
public class JeuTextuel {
	public static void main (String [] args)
	{
		...
		int NombreDonné= entrée.nextInt();
		int essais=0;
		while ((NombreDonné>10) || (1>NombreDonné))
		{
			int NombreDonnéError1=entrée.nextInt();
		...
		while (!(NombreDonné==NombreMystère))
		{
			...
			if (essais>=6 && 9>essais)
			{
				...
				int RéponseBaby=entrée.nextInt();
				...
				while ((NombreDonné>2) || (1>NombreDonné))
				{
					...
					int NombreDonnéErrorBaby=entrée.nextInt();
			...
			if (essais>=9)
			{
				...
				while (NombreDonné!=1)
				{
					System.out.println("j'ai dit :"
							+ "t a p e z  1");
					int NombreDonnéErrorWINALREADY=entrée.nextInt();
					NombreDonné=NombreDonnéErrorWINALREADY;
				}
		}
			if (essais>0 && 3>essais)
			{
			int NombreRéponse=entrée.nextInt();
